...
async def generate(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    BASE_PROMPT = """
cute 3D cartoon girl character, chibi style, big round brown eyes, smooth soft skin, small nose, soft smile, long straight black hair, center part, glossy hair,

wearing purple to teal gradient hoodie with small white S logo on left chest, zipper hoodie, clean minimal style, matching teal pants, sneakers,

full body, front view, symmetrical pose, soft studio lighting, clean background, high quality 3D render, pixar style, consistent character design
"""
    NEGATIVE_PROMPT = "ugly, realistic, blurry, low quality, bad anatomy, extra fingers, messy"

    FULL_PROMPT = f"{BASE_PROMPT} {user_input}".strip()
    ...
    try:
            ...
            async with session.post(
                ...
                if "data" in data and len(data["data"]) > 0:
                    ...
                    if "b64_json" in image_data:
                        ...
                        photo_io.name = "image.png"
                        await update.message.reply_photo(photo=photo_io)
        ...
        await status_message.edit_text("❌ Generation failed")
